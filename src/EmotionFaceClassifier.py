...
class EmotionFaceClassifier():
    ...
    def __init__(self, home, df_path):
    ...
    def run_analysis(self):
        ...
        self.run_cnn(model_name='CNN_cat_leaky', balanced=False, categorical=True)
        self.run_cnn(model_name='CNN_cat_bal_leaky', balanced=True, categorical=True)
        self.run_cnn(model_name='CNN_cont_leaky', balanced=False, categorical=False)
        self.run_cnn(model_name='CNN_cont_bal_leaky', balanced=True, categorical=False)
...
if __name__=='__main__':
    ...
    if not os.path.isdir('../images'):
        os.makedirs('../images')
    efc = EmotionFaceClassifier(home, df_path)
    efc.run_analysis()