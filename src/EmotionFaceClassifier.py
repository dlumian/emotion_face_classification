...
from simple_cnn import create_model4, plot_confusion_matrix, to_markdown, to_markdown_with_index
...
class EmotionFaceClassifier():
    ...
    def run_analysis(self):
        ...
        print('1. Running balanced CNN y categorical')
        self.bal_cnn_analysis_y_cat()
        print('2. Running balanced CNN y continuous')
        self.bal_cnn_analysis_y_cont()
        print('3. Running CNN y categorical')
        self.cnn_analysis_y_cat()
        print('4. Running CNN y categorical')
    ...
    def cnn_analysis_y_cont(self, img_dimensions=(48,48,1)):
        ...
        earlystop = EarlyStopping(monitor='loss',
                                      ...
                                      patience=2,
                                      verbose=0, mode='auto')
        self.bestmodelfilepath = "bestmodel_cont.hdf5"
        checkpoint = ModelCheckpoint(self.bestmodelfilepath, monitor='sparse_categorical_accuracy', verbose=1, save_best_only=True, mode='max')
    ...
    def bal_cnn_analysis_y_cont(self, img_dimensions=(48,48,1)):
        ...
        earlystop = EarlyStopping(monitor='loss',
                                      ...
                                      patience=2,
                                      verbose=0, mode='auto')
        self.bestmodelfilepath = "bal_bestmodel_cont.hdf5"
        checkpoint = ModelCheckpoint(self.bestmodelfilepath, monitor='acc', verbose=1, save_best_only=True, mode='max')
        self.model.fit_generator(self.train_generator, validation_data=self.test_generator, validation_steps=100, epochs=self.n_epochs, 
                                steps_per_epoch=50,
                                callbacks = [tensorboard, earlystop, checkpoint])
